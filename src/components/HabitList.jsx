...
function HabitList({ currentDate, openAddHabit, addHabitBtn, habit, setHabit }) {
  ...
  return (
    <div className='bg-main text-accent min-h-screen flex flex-col items-center pt-10'>
      ...
      <div className='self-start ml-21 mt-8 flex flex-col gap-x-2'>
        ...
        { addHabitBtn && 
        <button className={`${habit ? 'bg-accent' : 'bg-gray-300 opacity-30 cursor-not-allowed'} w-30 h-7 text-main text-sm rounded-sm self-end mt-3`}>Add Habit</button>
        }
      </div>
